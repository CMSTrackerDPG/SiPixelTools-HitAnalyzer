...
process.DBReaderFrontier = cms.ESSource("PoolDBESSource",
 ...
 toGet = cms.VPSet(
   ...
   record = cms.string('SiPixelGainCalibrationOfflineRcd'),
    tag = cms.string('SiPixelGainCalibration_2021_v0') 
    ),
   ),
...
process.siPixelClustersPreSplitting.cpu.VCaltoElectronGain = 1  # for Run3 
process.siPixelClustersPreSplitting.cpu.VCaltoElectronOffset = 0
process.siPixelClustersPreSplitting.cpu.VCaltoElectronGain_L1 = 1  # 
process.siPixelClustersPreSplitting.cpu.VCaltoElectronOffset_L1 = 0
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('digis_clus_2021v0_offline.root')
)
